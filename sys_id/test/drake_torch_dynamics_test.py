...
from drake_sys_id.sys_id.dair_pll_inertia import parallel_axis_theorem
from drake_sys_id.sys_id.drake_torch_dynamics import (
...
from drake_sys_id.common.path_util import resolve_path


def add_model_panda_j7(plant):
    model_file = resolve_path("package://drake_sys_id/models/panda_j7.urdf")
...
def add_model_panda(plant):
    model_file = resolve_path(
        "package://drake_sys_id/models/add_panda.dmd.yaml"
    )
